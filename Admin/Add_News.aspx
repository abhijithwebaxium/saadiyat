<%@ Page Title="" Language="C#" ValidateRequest="false" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Add_News.aspx.cs" Inherits="Admin_Add_News" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <%--<script src="https://cdn.tiny.cloud/1/l4867daquuwnxwm29k5nb31h1b8q8e4uqfms0tbqa9q4g0h4/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    <script>
        tinymce.init({
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <main class="content">
        <div class="container-fluid">
            <div class="header">
                <h1 class="header-title">ADD NEWS</h1>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
