<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="View_Blogs.aspx.cs" Inherits="Admin_View_Blogs" %>
        ...
        <div class="container">
          <div class="jumbotron" style="margin-top: 5px">
                <div class="block-header">
                    <h3 style="font-size: x-large">Blogs List:</h3>
                    <br />
                </div>
